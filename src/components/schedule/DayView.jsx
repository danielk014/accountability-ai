...
export default function DayView({ date, tasks, completions, onToggle, onDropTask, onRemoveTask }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden flex-1">
      {/* Untimed tasks — rendered ABOVE the hour grid, not inside it */}
      {untimedTasks.length > 0 && (
        <div className="border-b border-slate-100 px-4 py-2 space-y-1 bg-slate-50/50">
          <p className="text-xs text-slate-400 font-medium mb-1">No time set</p>
